...
print(path.exists("Dcsv"))
if path.exists("Dcsv"):
    rmtree("Dcsv")

# Creating Directory for files.nc
path_act=os.getcwd()
os.mkdir("Dcsv", 0o777)
...
archivos = ls()
for indexx in archivos:
    ncfile = indexx     # el programa debe estar en la misma carpeta de las extensiones .nc
    ...
    file_csv_name = "Dcsv/"+"df"+file_sep[0] + ".csv"   # generating the name for csv file
